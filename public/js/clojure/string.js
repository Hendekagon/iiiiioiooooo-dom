...
{{
var G__5772 = cljs.core.pop(v__$1);
v__$1 = G__5772;
continue;
}
} else
...
{return (limit >= (2 + cljs.core.count(s)));
}
})())
{return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(cljs.core.cons("",cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.seq(s)))),"");
} else
{var pred__5776 = cljs.core._EQ_;var expr__5777 = limit;if((pred__5776.cljs$core$IFn$_invoke$arity$2 ? pred__5776.cljs$core$IFn$_invoke$arity$2(1,expr__5777) : pred__5776.call(null,1,expr__5777)))
{return cljs.core.vector.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([s], 0));
} else
{if((pred__5776.cljs$core$IFn$_invoke$arity$2 ? pred__5776.cljs$core$IFn$_invoke$arity$2(2,expr__5777) : pred__5776.call(null,2,expr__5777)))
{return cljs.core.vector.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq(["",s], 0));
} else
...
var G__5779 = s__$1.substring((index + cljs.core.count(m)));
var G__5780 = (limit__$1 - 1);
var G__5781 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring(0,index));
s__$1 = G__5779;
limit__$1 = G__5780;
parts = G__5781;
continue;
...
{var ch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(s,(index - 1));if((function (){var or__3943__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(ch,"\n");if(or__3943__auto__)
{return or__3943__auto__;
} else
...
{var ch = s.charAt(index);var temp__4090__auto___5783 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4090__auto___5783))
{var replacement_5784 = temp__4090__auto___5783;buffer.append([cljs.core.str(replacement_5784)].join(''));
} else
{buffer.append(ch);
}
{
